...
public class AjaxTestServer extends NanoHTTPD {
	...
	public Response serve(String uri, String method, Properties header, Properties parms) {
		...
		if ("/ajaxValidateFieldUser".equals(uri)) {
			...
			Boolean validation = new Boolean("karnius".equals(fieldValue));
			String[] result = { fieldId, validation.toString() };
			...
			Boolean validation = new Boolean("duncan".equals(fieldValue));
			String[] result = { fieldId, validation.toString() };
			String json = genError(result);
